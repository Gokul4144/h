  ...
  return (
    <>
      <Head>
        ...
        {/* Make sure your globals.css is in the 'styles' directory or adjust path */}
              ...
              <ul id="MenuItems">
                ...
                <li className="dropdown">
                  ...
                  <ul id="inneritems">
                    ...
                    <li><Link href="/serums">Serums</Link></li> {/* Changed to lowercase for consistency with Next.js conventions */}
                    <li><Link href="/cleansers">Cleansers</Link></li> {/* Changed to lowercase */}
                    <li><Link href="/sunscreens">Sunscreens</Link></li> {/* Changed to lowercase */}
                  </ul>
                </li>
                <li><Link href="/about">About</Link></li> {/* Removed .js as it's not needed for Next.js file-based routing */}
        ...
        <div className="offer">
          <div className="row">
            ...
            <div className="col-2">
              ...
              <Link href="/l-ascorbic-acid-8-lip-treatment-balm" className="btn">Buy Now &#10140;</Link> {/* Changed to kebab-case */}
            </div>
          </div>
        </div>
          ...
          <div className="container-f">
            <div className="row-f">
              <div className="footer-col">
                <h4>get help</h4>
                <ul>
                  <li><Link href="/faq">FAQ</Link></li> {/* Added Link */}
                  <li><Link href="/shipping">shipping</Link></li> {/* Added Link */}
                  <li><Link href="/returns">returns</Link></li> {/* Added Link */}
                  <li><Link href="/order-status">order status</Link></li> {/* Added Link */}
                  <li><Link href="/payment-options">payment options</Link></li> {/* Added Link */}
                </ul>
              </div>
              <div className="footer-col">
                <h4>company</h4>
                <ul>
                  ...
                  <li><Link href="/privacy-policy">Privacy Policy</Link></li> {/* Added Link */}
                </ul>
              </div>
              <div className="footer-col">
                <h4>follow us</h4>
                <div className="social-links">
                  {/* These can be external links or internal pages */}
